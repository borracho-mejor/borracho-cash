...
export async function build_smartBCH_page(
  ...
  if (projects.length == 0) {
    ...
    if (specificProject) {
      html += `<div class="card mb-3 mr-1"><div class="card-body"><h5 style="text-align:left;">This is a specific ddproject that was shared from the <a href="https://borracho.cash/smartbch" target="_blank">borracho.cash/smartbch</a> listings. 
